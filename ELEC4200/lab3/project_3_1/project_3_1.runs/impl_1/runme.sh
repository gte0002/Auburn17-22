...
HD_PWD='C:/Users/gte0002/lab3_mod/project_3_1/project_3_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_3to8DEC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab3_3to8DEC.tcl -notrace
