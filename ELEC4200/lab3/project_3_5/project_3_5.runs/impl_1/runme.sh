...
HD_PWD='C:/Users/gte0002/lab3_mod/project_3_5/project_3_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_Multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab3_Multiplier.tcl -notrace
