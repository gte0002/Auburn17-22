...
HD_PWD='C:/Users/gte0002/lab3_mod/project_3_5/project_3_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_Multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab3_Multiplier.tcl
