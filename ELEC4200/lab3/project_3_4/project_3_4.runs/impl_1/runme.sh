...
HD_PWD='C:/Users/gte0002/lab3_mod/project_3_4/project_3_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_Comparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab3_Comparator.tcl -notrace
