...
HD_PWD='C:/Users/gte0002/lab3_mod/project_3_2/project_3_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_IC_Design.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab3_IC_Design.tcl -notrace
