...
HD_PWD='C:/Users/gte0002/lab3_mod/project_3_3/project_3_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_8to3ENC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab3_8to3ENC.tcl -notrace
