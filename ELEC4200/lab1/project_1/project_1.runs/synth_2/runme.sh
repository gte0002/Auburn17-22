...
HD_PWD='C:/Users/gte0002/lab1_mod/project_1/project_1.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_gateLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1_gateLevel.tcl
