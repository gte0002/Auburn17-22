...
HD_PWD='C:/Users/gte0002/lab1_mod/project_1/project_1.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_gateLevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab1_gateLevel.tcl -notrace
