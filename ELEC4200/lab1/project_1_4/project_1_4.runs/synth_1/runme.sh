...
HD_PWD='C:/Users/gte0002/lab1_mod/project_1_4/project_1_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_Behavioral.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1_Behavioral.tcl
