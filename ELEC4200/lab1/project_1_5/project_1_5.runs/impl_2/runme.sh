...
HD_PWD='C:/Users/gte0002/lab1_mod/project_1_5/project_1_5.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_3to1MUX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab1_3to1MUX.tcl -notrace
