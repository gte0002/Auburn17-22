...
HD_PWD='C:/Users/gte0002/lab1_mod/project_1_2/project_1_2.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_gateLevel_2wide.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1_gateLevel_2wide.tcl
