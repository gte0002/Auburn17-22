...
HD_PWD='C:/Users/gte0002/lab1_mod/project_1_2/project_1_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_gateLevel_2wide.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab1_gateLevel_2wide.tcl -notrace
