...
ISEStep( "vivado",
         "-log Register_with_synch_reset_set_load_ehavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Register_with_synch_reset_set_load_ehavior.tcl" );
