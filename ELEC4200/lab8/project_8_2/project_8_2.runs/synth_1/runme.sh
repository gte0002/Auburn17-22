...
HD_PWD='C:/Users/gte0002/lab8_mod/project_8_2/project_8_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Register_with_synch_reset_set_load_ehavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Register_with_synch_reset_set_load_ehavior.tcl
