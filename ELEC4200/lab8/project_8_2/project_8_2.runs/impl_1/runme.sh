...
HD_PWD='C:/Users/gte0002/lab8_mod/project_8_2/project_8_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Register_with_synch_reset_set_load_ehavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Register_with_synch_reset_set_load_ehavior.tcl -notrace
