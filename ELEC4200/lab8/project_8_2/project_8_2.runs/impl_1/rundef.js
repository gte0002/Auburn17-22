...
ISEStep( "vivado",
         "-log Register_with_synch_reset_set_load_ehavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Register_with_synch_reset_set_load_ehavior.tcl -notrace" );
