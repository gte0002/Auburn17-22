...
HD_PWD='C:/Users/gte0002/lab8_mod/project_8_7/project_8_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dff_counter_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dff_counter_8bit.tcl
