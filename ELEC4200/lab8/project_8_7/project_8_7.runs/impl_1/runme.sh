...
HD_PWD='C:/Users/gte0002/lab8_mod/project_8_7/project_8_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dff_counter_8bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dff_counter_8bit.tcl -notrace
