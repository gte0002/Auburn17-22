...
HD_PWD='C:/Users/gte0002/lab8_mod/project_8_8/project_8_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log downcounter_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source downcounter_4bit.tcl
