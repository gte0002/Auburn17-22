...
HD_PWD='C:/Users/gte0002/lab8_mod/project_8_8/project_8_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log downcounter_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source downcounter_4bit.tcl -notrace
