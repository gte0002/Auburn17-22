...
HD_PWD='C:/Users/gte0002/lab10_mod/project_10_1/project_10_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab10_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab10_1.tcl -notrace
