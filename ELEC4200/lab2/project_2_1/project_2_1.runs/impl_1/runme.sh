...
HD_PWD='C:/Users/gte0002/lab2_mod/project_2_1/project_2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_7Seg_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2_7Seg_decoder.tcl -notrace
