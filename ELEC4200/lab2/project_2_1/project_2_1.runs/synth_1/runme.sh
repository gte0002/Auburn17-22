...
HD_PWD='C:/Users/gte0002/lab2_mod/project_2_1/project_2_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_7Seg_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2_7Seg_decoder.tcl
