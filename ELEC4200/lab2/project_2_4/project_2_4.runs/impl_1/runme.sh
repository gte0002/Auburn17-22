...
HD_PWD='C:/Users/gte0002/lab2_mod/project_2_4/project_2_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_FA_and_RCA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2_FA_and_RCA.tcl -notrace
