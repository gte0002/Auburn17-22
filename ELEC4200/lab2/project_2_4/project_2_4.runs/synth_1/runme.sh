...
HD_PWD='C:/Users/gte0002/lab2_mod/project_2_4/project_2_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_FA_and_RCA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2_FA_and_RCA.tcl
