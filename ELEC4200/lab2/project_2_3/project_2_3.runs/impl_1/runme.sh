...
HD_PWD='C:/Users/gte0002/lab2_mod/project_2_3/project_2_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_2outof5_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2_2outof5_dataflow.tcl -notrace
