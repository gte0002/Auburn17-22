...
HD_PWD='C:/Users/gte0002/lab2_mod/project_2_2/project_2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_4to2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2_4to2.tcl -notrace
