...
HD_PWD='C:/Users/gte0002/lab4_mod/project_4_3/project_4_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4_D_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab4_D_dataflow.tcl -notrace
