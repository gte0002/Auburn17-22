...
HD_PWD='C:/Users/gte0002/lab4_mod/project_4_3/project_4_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4_D_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab4_D_dataflow.tcl
