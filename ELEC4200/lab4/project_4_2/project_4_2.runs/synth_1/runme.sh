...
HD_PWD='C:/Users/gte0002/lab4_mod/project_4_2/project_4_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4_SR_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab4_SR_dataflow.tcl
