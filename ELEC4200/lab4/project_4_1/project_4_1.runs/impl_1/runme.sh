...
HD_PWD='C:/Users/gte0002/lab4_mod/project_4_1/project_4_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4_SR_Latch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab4_SR_Latch.tcl -notrace
