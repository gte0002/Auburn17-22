...
HD_PWD='C:/Users/gte0002/lab4_mod/project_4_1/project_4_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4_SR_Latch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab4_SR_Latch.tcl
