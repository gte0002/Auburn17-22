...
HD_PWD='C:/Users/gte0002/lab4_mod/project_4_6/project_4_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4_synch_reset.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab4_synch_reset.tcl -notrace
