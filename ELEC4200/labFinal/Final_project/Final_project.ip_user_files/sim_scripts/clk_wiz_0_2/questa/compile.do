...
vlog -work xpm  -incr -mfcu -sv "+incdir+../../../ipstatic" "+incdir+../../../../Final_project.gen/sources_1/ip/clk_wiz_0" \
"D:/Xilinx/Vivado/2021.1/data/ip/xpm/xpm_cdc/hdl/xpm_cdc.sv" \

vcom -work xpm  -93 \
"D:/Xilinx/Vivado/2021.1/data/ip/xpm/xpm_VCOMP.vhd" \

vlog -work xil_defaultlib  -incr -mfcu "+incdir+../../../ipstatic" "+incdir+../../../../Final_project.gen/sources_1/ip/clk_wiz_0" \
