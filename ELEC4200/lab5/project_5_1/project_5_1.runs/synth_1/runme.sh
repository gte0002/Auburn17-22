...
HD_PWD='C:/Users/gte0002/lab5_mod/project_5_1/project_5_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_Mealy.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab5_Mealy.tcl
