...
HD_PWD='C:/Users/gte0002/lab5_mod/project_5_1/project_5_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_Mealy.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab5_Mealy.tcl -notrace
