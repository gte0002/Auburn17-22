...
HD_PWD='C:/Users/gte0002/lab5_mod/project_5_2/project_5_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_Moore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab5_Moore.tcl
