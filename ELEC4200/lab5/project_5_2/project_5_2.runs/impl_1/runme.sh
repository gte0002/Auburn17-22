...
HD_PWD='C:/Users/gte0002/lab5_mod/project_5_2/project_5_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_Moore.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab5_Moore.tcl -notrace
