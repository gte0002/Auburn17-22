...
public class UseTaxListTest {
   ...
   *@throws NegativeValueException if value is less than 0.
   */
   @Test public void addExcludedRecord() throws NegativeValueException {
      Vehicle car1 = new Car("Sams, Joe", "2017 Honda Accura",
                               23000, false);
      Vehicle car2 = new Car("Jones, Sam", "2017 Honda Accord",
                               22000, false); 
      ...
      UseTaxList tax = new UseTaxList();
      //Assert.assertEquals("addexcludedRecord", "a", 
                     //tax.addExcludedRecord(test));
   }
  /**
   *@throws NegativeValueException if value is less than 0.
   */
   @Test public void getTaxDistrict() throws NegativeValueException {
      Vehicle car1 = new Car("Sams, Joe", "2017 Honda Accura",
                               23000, false);
      Vehicle car2 = new Car("Jones, Sam", "2017 Honda Accord",
                               22000, false); 
   ...
   *@throws NegativeValueException if value is less than 0.
   */
   @Test public void setTaxDistrictTest() throws NegativeValueException {
      Vehicle car1 = new Car("Sams, Joe", "2017 Honda Accura",
                               23000, false);
