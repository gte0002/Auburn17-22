         ...
         try {
            ...
            switch (type) {
               case 'C':
                  ...
                  Vehicle vehicle = new Car(owner, yearMakeModel, 
                                             value, altFuel);
                  addVehicle(vehicle);
                  break;
               ...
               case 'S':
                  ...
                  Vehicle vehicle3 = new SemiTractorTrailer(owner, 
                     yearMakeModel, value, altFuel, tons2, axles);
                  addVehicle(vehicle3);
                  break;
               ...
               case 'M':
                  ...
                  Vehicle vehicle4 = new Motorcycle(owner, 
                              yearMakeModel, value, altFuel, engSize);
                  addVehicle(vehicle4);
                  break;
