...
/**
 * DoubleEndedListInterface.java. Describes the abstract
 * behavior of a double-ended list. Elements can be inserted
 * and deleted from either end of the list, but not from
 * any other location.
 *
 ...
 *
 */
public interface DoubleEndedListInterface<T> extends ListInterface<T> {
